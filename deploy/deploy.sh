...
APP_DIR="${APP_DIR:-/opt/ducktivity/drinkwater}"          # the git clone root; the compose project root is $APP_DIR/deploy
...
READYZ_HOST="${READYZ_HOST:-drinkwater-backend}"          # compose network alias of the app
