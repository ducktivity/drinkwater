...
/**
 * Kicks off the desktop auto-update check once on startup. Renders nothing; it
 * lives inside the providers purely so the updater can raise a toast. No-op on
 * the web (see updater.ts).
 */
